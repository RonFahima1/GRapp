...
export default function WelcomeRTL() {
    ...
    <View style={[styles.container, styles.rtlContainer]}>
      ...
      <View style={styles.content}>
        <Image 
          ...
          resizeMode="contain"
        />
        <Text style={[styles.title, styles.rtlText]}>{t('welcome_to_remit', 'Welcome to Remit')}</Text>
        <Text style={[styles.subtitle, styles.rtlText]}>{t('enter_phone_subtitle', 'Enter your phone number to get started')}</Text>
