...
import { ChevronLeft, ChevronDown, Building2, CreditCard } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={[styles.header, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
        ...
        <Text style={styles.headerTitle} accessibilityRole="header">{t('moneyTransfer.details.title')}</Text>
      ...
      <ScrollView 
        ...
        accessibilityLabel={t('moneyTransfer.details.title')}
      >
        <View style={styles.summaryContainer}>
          <Text style={[styles.summaryTitle, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.transferSummary')}</Text>
          
          <View style={[styles.summaryRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <Text style={[styles.summaryLabel, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.to')}</Text>
            <Text style={[styles.summaryValue, { textAlign: isRTL ? 'right' : 'left' }]}>{String(recipientName)}</Text>
          </View>
          
          <View style={[styles.summaryRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <Text style={[styles.summaryLabel, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.amount')}</Text>
          ...
          <View style={[styles.summaryRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <Text style={[styles.summaryLabel, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.when')}</Text>
            <Text style={[styles.summaryValue, { textAlign: isRTL ? 'right' : 'left' }]}>
              {transferTypeValue === 'immediate' ? t('moneyTransfer.details.immediateTransfer') : t('moneyTransfer.details.scheduledTransfer')}
            </Text>
          </View>
          
          <View style={[styles.summaryRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <Text style={[styles.summaryLabel, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.account')}</Text>
            <Text style={[styles.summaryValue, { textAlign: isRTL ? 'right' : 'left' }]}>{String(accountNumber)}</Text>
          </View>
        </View>
        
        <View style={styles.paymentMethodContainer}>
          <Text style={[styles.sectionTitle, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.paymentMethod')}</Text>
          ...
          <View style={[styles.paymentOptions, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <TouchableOpacity
              ...
              accessibilityLabel={t('moneyTransfer.details.bankAccount')}
              accessibilityRole="button"
            >
              <Building2 
              ...
              <Text style={[
                ...
                {t('moneyTransfer.details.bankAccount')}
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              accessibilityLabel={t('moneyTransfer.details.creditDebitCard')}
              accessibilityRole="button"
            >
              <CreditCard 
              ...
              <Text style={[
                ...
                {t('moneyTransfer.details.creditDebitCard')}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        {selectedPaymentMethod === 'bank' && (
          <View style={styles.bankSelectionContainer}>
            <Text style={[styles.sectionTitle, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.selectBank')}</Text>
        ...
        {selectedPaymentMethod === 'card' && (
          <View style={styles.cardSelectionContainer}>
            <Text style={[styles.sectionTitle, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.selectCard')}</Text>
            ...
            <TouchableOpacity 
              ...
              accessibilityLabel={t('moneyTransfer.details.addNewCard')}
              accessibilityRole="button"
            >
              <Text style={[styles.addCardButtonText, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.addNewCard')}</Text>
            </TouchableOpacity>
          </View>
        )}
        
        <View style={styles.feeContainer}>
          <Text style={[styles.feeTitle, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.feeBreakdown')}</Text>
          
          <View style={[styles.feeRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <Text style={[styles.feeLabel, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.transferAmount')}</Text>
          ...
          <View style={[styles.feeRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <Text style={[styles.feeLabel, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.transferFee')}</Text>
          ...
          <View style={[styles.totalRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            <Text style={[styles.totalLabel, { textAlign: isRTL ? 'right' : 'left' }]}>{t('moneyTransfer.details.total')}</Text>
      ...
      <View style={styles.footer}>
        <TouchableOpacity 
          ...
          accessibilityLabel={t('moneyTransfer.details.continue')}
          accessibilityRole="button"
        >
          <Text style={styles.continueButtonText}>{t('moneyTransfer.details.continue')}</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
