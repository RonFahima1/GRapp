...
const EditMailingAddressScreen = () => {
  ...
  const verifyOTP = () => {
    if (otp.length === 6) {
      ...
      Alert.alert('Address Updated', 'Your mailing address has been successfully updated', [
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <Text style={styles.descriptionText}>
          Update your mailing address where you would like to receive important documents
        </Text>
